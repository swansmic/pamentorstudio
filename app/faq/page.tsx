    ...
    items: [
      {
        ...
        answer:
          "Session frequency varies by pathway and stage of preparation. In general, sessions are structured around what is most useful at each point in your process — more frequent during active application periods, less frequent in developmental phases. The specifics are established during onboarding and adjusted as needed.",
      },
      {
